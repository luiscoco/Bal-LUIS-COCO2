...
namespace Dalssoft.DiagramNet
{
	...
	public class ElipseNode: NodeElement, IControllable, ILabelElement
	{
		...
		public ElipseNode(): this(0, 0, 100, 100,1)
		{}

		public ElipseNode(Rectangle rec,int tipoelemento): this(rec.Location, rec.Size,tipoelemento)
		{}

		public ElipseNode(Point l, Size s,int tipoelemento): this(l.X, l.Y, s.Width, s.Height,tipoelemento) 
		{}

		public ElipseNode(int top, int left, int width, int height,int tipoelemento): base(top, left, width, height,tipoelemento)
		{
