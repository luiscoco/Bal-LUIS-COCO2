...
namespace Dalssoft.DiagramNet
{
	...
	{
        protected Color fillColor1 = Color.DodgerBlue;
		...
		public RectangleElement(int top, int left, int width, int height)
		{
            ...
            base.Point1.X = location.X;
            base.Point1.X = location.Y;

            base.Point2.X = location.X + size.Width;
            base.Point2.Y = location.Y + size.Height;
		}
