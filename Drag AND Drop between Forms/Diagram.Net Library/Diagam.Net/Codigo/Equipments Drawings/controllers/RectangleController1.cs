...
namespace Dalssoft.DiagramNet
{
	...
	/// </summary>
	internal class RectangleController1: IController, IMoveController, IResizeController
	{
		//parent element
        ...
        //Definimos un Enum que contiene la posición de los Retangulitos
		...
		public RectangleController1(BaseElement element)
		{
			el = element;

			//Create corners. Inicializamos los rectangulitos con el tamaño elegido anteriormente "selCornerSize=3"
        ...
        //Funciones que detectan se hemos clickado dentro del rectángulo del Elemento (recibe como argumento un punto,donde hemos clickado)
        ...
        //Funciones que detectan se hemos clickado dentro del rectángulo del Elemento (recibe como argumento un rectangulo, el rectangulo que hemos seleccionado)
        ...
        //Dibujamos el Rectángulo de Selección 
        ...
        //Esta función recibe como argumento el punto donde hemos clickado y devuelve el punto hasta donde hemos arrastrado
        ...
        //Esta función asigna la nueva posición del elemento movido 
        ...
        //Esta función actualiza la posición de los Rectángulos de Selección
        ...
        //Esta función detecta dentro de que Rectangulito de Selección hemos clickado
        ...
        //Esta función calcula el punto final hasta donde relizamos el Resize
        ...
        //Esta función cambia de tamaño el objeto el del cual hemos realizado el Resize
