...
namespace Dalssoft.DiagramNet
{
	...
	/// </summary>
	internal class CirculoResultadosController: RectangleController, IController
	{
		public CirculoResultadosController(BaseElement element): base(element)
		{
		}
		...
		public override void DrawSelection(System.Drawing.Graphics g)
		{
            ...
            if ((el.Location.X > 0) && (el.Location.Y > 0) && (el.Size.Width > 0) && (el.Size.Height > 0))
            {
                ...
                g.DrawEllipse(p1, new Rectangle(el.Location, el.Size));
                //g.FillEllipse(b, new Rectangle(el.Location, el.Size));
