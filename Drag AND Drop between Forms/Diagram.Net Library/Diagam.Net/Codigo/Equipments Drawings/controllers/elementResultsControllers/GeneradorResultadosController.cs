...
namespace Dalssoft.DiagramNet
{
	...
	/// </summary>
	internal class GeneradorResultadosController: RectangleController, IController
	{
		public GeneradorResultadosController(BaseElement element): base(element)
		{
		}
		...
		public override void DrawSelection(System.Drawing.Graphics g)
		{
            ...
            if ((el.Location.X > 0) && (el.Location.Y > 0) && (el.Size.Width > 0) && (el.Size.Height > 0))
            {
                ...
                puntos[0].Y = el.Location.Y + 2 * el.Size.Height / 4;
