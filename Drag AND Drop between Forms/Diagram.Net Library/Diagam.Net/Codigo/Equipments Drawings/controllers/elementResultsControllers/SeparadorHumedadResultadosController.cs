...
namespace Dalssoft.DiagramNet
{
	...
	/// </summary>
	internal class SeparadorHumedadResultadosController: RectangleController, IController
	{
		public SeparadorHumedadResultadosController(BaseElement element): base(element)
		{
		}
		...
		public override void DrawSelection(System.Drawing.Graphics g)
		{
            ...
            if ((el.Location.X > 0) && (el.Location.Y > 0) && (el.Size.Width > 0) && (el.Size.Height > 0))
            {
                ...
                puntos[2].Y = el.Location.Y + 3 * el.Size.Height / 4;
                puntos[3].X = el.Location.X + el.Size.Width / 2;
                puntos[3].Y = el.Location.Y + el.Size.Height;
                puntos[4].X = el.Location.X;
