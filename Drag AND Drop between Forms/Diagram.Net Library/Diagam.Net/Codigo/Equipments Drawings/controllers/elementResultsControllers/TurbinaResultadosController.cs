...
namespace Dalssoft.DiagramNet
{
	...
	/// </summary>
	internal class TurbinaResultadosController: RectangleController, IController
	{
		public TurbinaResultadosController(BaseElement element): base(element)
		{
		}
		...
		public override void DrawSelection(System.Drawing.Graphics g)
		{
            ...
            puntos[1].X = el.Location.X + el.Size.Width / 2;
            puntos[1].Y = el.Location.Y + el.Size.Height / 4;
            ...
            puntos[4].X = el.Location.X + el.Size.Width / 2;
            puntos[4].Y = el.Location.Y + 3 * el.Size.Height / 4;
            puntos[5].X = el.Location.X;
            puntos[5].Y = el.Location.Y + el.Size.Height;       
