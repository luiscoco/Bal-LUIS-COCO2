...
{
	[Serializable]
	public class GeneradorElementResultados: RectangleElement, IControllable
	{
		[NonSerialized]
		private GeneradorResultadosController controller;

		public GeneradorElementResultados(): base() {}

		public GeneradorElementResultados(Rectangle rec): base(rec) {}

		public GeneradorElementResultados(Point l, Size s): base(l, s) {}

        public GeneradorElementResultados(int top, int left, int width, int height) : base(top, left, width, height) { }
		...
		internal override void Draw(Graphics g)
		{
            ...
            puntos[0].Y = this.Location.Y + 2 * this.Size.Height / 4;
		...
		{
			if (controller == null)
				controller = new GeneradorResultadosController(this);
			return controller;
		}
	}
}
