...
{
	[Serializable]
	public class RectanguloElementResultados: RectangleElement, IControllable
	{
		[NonSerialized]
		private RectanguloResultadosController controller;

		public RectanguloElementResultados(): base() {}

		public RectanguloElementResultados(Rectangle rec): base(rec) {}

		public RectanguloElementResultados(Point l, Size s): base(l, s) {}

        public RectanguloElementResultados(int top, int left, int width, int height) : base(top, left, width, height) { }
		...
		{
			if (controller == null)
				controller = new RectanguloResultadosController(this);
			return controller;
		}
	}
}
