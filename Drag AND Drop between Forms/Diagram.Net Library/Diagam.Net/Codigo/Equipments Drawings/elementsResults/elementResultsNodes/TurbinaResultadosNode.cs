...
{
	[Serializable]
	public class TurbinaResultadoNode: NodeElement, IControllable, ILabelElement
	{
        protected TurbinaElementResultados turbina;
		...
		public TurbinaResultadoNode(): this(0, 0, 100, 100,9)
		{
        
        }

		public TurbinaResultadoNode(Rectangle rec,int tipoelemento2): this(rec.Location, rec.Size,tipoelemento2)
		{ 
        
        }

		public TurbinaResultadoNode(Point l, Size s,int tipoelemento2): this(l.X, l.Y, s.Width, s.Height,tipoelemento2) 
		{
           
        }

		public TurbinaResultadoNode(int top, int left, int width, int height,int tipoelemento2): base(top, left, width,height,tipoelemento2)
		{
            turbina = new TurbinaElementResultados(top, left, width, height);
