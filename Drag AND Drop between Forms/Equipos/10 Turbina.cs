...
namespace Drag_AND_Drop_between_Forms
{
    public partial class Turbina10 : Form
    {
        ...
        public Turbina10(Aplicacion punteroaplicion, Double numecuaciones1, Double numvariables1,Double ediciononuevo,int indice)
        {
            InitializeComponent();
        ...
        public void funcionauxiliar1()
        {
            ...
            if (ediciononuevo1 == 0)
            {
                ...
                Equipos turbina10 = new Equipos();
                turbina10.Inicializar(numequipo, 10, correntrada, 0, corrsalida, 0, D1, D2, D3, D4, D5, 0, 0, D8, 0, 0, 0, 0, 0);
                //Copio los valores de la clase de entrada de datos en la aplicación principal
                punteroaplicacion1.equipos11.Add(turbina10);
