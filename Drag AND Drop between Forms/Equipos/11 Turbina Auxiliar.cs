...
{
    public partial class TurbinaAuxiliar : Form
    {
        public Double D1,D2,D5;
        ...
        public TurbinaAuxiliar(Aplicacion punteroaplicion, Double numecuaciones1, Double numvariables1, Double ediciononuevo, int indice)
        {
            InitializeComponent();
        ...
        public void funcionauxiliar()
        {
            ...
            //ERROR: Deberíamos enviar también D5 a la función generaecuaciones()
            ecuaciones1 = generaecucaiones(D1,D2, correntrada, corrsalida);
        ...
        private List<String> generaecucaiones(Double D1,Double D2, Double correntrada, Double corrsalida)
        {
            //Lista de cadenas que guardan las ecuaciones del sistema
            ...
            {
                ecuaciones2.Add("");
                ecuaciones2[auxiliar] = "W" + Convert.ToString(correntrada) +"(Hsalida-Hentrada)"+"-" + Convert.ToString(D2);
                auxiliar++;
            }
            ...
            {
                ecuaciones2.Add("");
                ecuaciones2[auxiliar] = "H" + Convert.ToString(corrsalida) + "-" + "H" + Convert.ToString(correntrada) + "+" + Convert.ToString(D1) + "*" + "(" + "H" + Convert.ToString(correntrada) + "-" + "Hs" + Convert.ToString(corrsalida) + ")";
                auxiliar++;
            }
        ...
        public void funcionauxiliar1()
        {
            ...
            if (ediciononuevo1 == 0)
            {
                ...
                Equipos turbauxiliar1 = new Equipos();
                turbauxiliar1.Inicializar(numequipo, 11, correntrada, 0, corrsalida, 0, D1, D2, 0, 0, D5, 0, 0, 0, 0, 0, 0, 0, 0);
                //Copio los valores de la clase de entrada de datos en la aplicación principal
                punteroaplicacion1.equipos11.Add(turbauxiliar1);
