...
{
    public partial class EnfriadorDrenajes : Form
    {
        public Double D1,D2, D3, D4, D6, D8;
        ...
        public EnfriadorDrenajes(Aplicacion punteroaplicion, Double numecuaciones1, Double numvariables1, Double ediciononuevo, int indice)
        {
            InitializeComponent();           
        ...
        public void funcionauxiliar()
        {
            ...
            ecuaciones1=generaecucaiones(D1,D2,D3,D4,D6,D8,correntrada1,correntrada2,corrsalida1,corrsalida2);
        ...
        private List<String> generaecucaiones(Double D1, Double D2, Double D3, Double D4, Double D6, Double D8, Double correntrada1, Double correntrada2, Double corrsalida1, Double corrsalida2)
        {
            //Lista de cadenas que guardan las ecuaciones del sistema
        ...
        public void funcionauxiliar1() 
        {
            ...
            if (ediciononuevo1 == 0)
            {
                ...
                Equipos enfriador16 = new Equipos();
                enfriador16.Inicializar(numequipo, 16, correntrada1, correntrada2, corrsalida1, corrsalida2, D1, D2, D3, D4, 0, D6, 0, D8, 0, 0, 0, 0, 0);
                //Copio los valores de la clase de entrada de datos en la aplicación principal
                punteroaplicacion1.equipos11.Add(enfriador16);
