...
namespace Drag_AND_Drop_between_Forms
{
    public partial class Desaireador : Form
    {
        ...
        public Desaireador(Aplicacion punteroaplicion, Double numecuaciones1, Double numvariables1, Double ediciononuevo, int indice)
        {
            InitializeComponent();           
        ...
        {
            D5=Convert.ToDouble(textBox1.Text);
            D6=Convert.ToDouble(textBox2.Text);
            D7=Convert.ToDouble(textBox3.Text);
            D9 = Convert.ToDouble(textBox5.Text);

            correntrada1 =Convert.ToDouble(textBox7.Text);
            correntrada2 = Convert.ToDouble(textBox6.Text);
        ...
        public void funcionauxiliar()
        {
            ...
            ecuaciones1=generaecucaiones(D5,D6,D7,D9,correntrada1,correntrada2,corrsalida1,corrsalida2);
        ...
        private List<String> generaecucaiones(Double D5, Double D6,Double D7,Double D9, Double correntrada1,Double correntrada2, Double corrsalida1,Double corrsalida2)
        {
            //Lista de cadenas que guardan las ecuaciones del sistema
            List<String> ecuaciones2 = new List<String>();
           
            ecuaciones2.Add("");
            ecuaciones2[auxiliar] = "W" + Convert.ToString(correntrada1) + "-" + "W" + Convert.ToString(corrsalida1) + "-" + "W" + Convert.ToString(corrsalida2);
            auxiliar++;

            ecuaciones2.Add("");
            ecuaciones2[auxiliar] = "P" + Convert.ToString(correntrada1) + "-" + "P" + Convert.ToString(corrsalida1);
           
            auxiliar++;

            ecuaciones2.Add("");
            ecuaciones2[auxiliar] = "H" + Convert.ToString(correntrada1) + "-" + "H" + Convert.ToString(corrsalida1);
          
            auxiliar++;

            ecuaciones2.Add("");
            ecuaciones2[auxiliar] = "P" + Convert.ToString(correntrada1) + "-" + "P" + Convert.ToString(corrsalida2);
           
            auxiliar++;

            ecuaciones2.Add("");
            ecuaciones2[auxiliar] = "H" + Convert.ToString(correntrada1) + "-" + "H" + Convert.ToString(corrsalida2);
        ...
        public void funcionauxiliar1()
        {
            ...
            if (ediciononuevo1 == 0)
            {
                ...
                Equipos desaireador18 = new Equipos();
                desaireador18.Inicializar(numequipo, 18, correntrada1, correntrada2, corrsalida1, corrsalida2, 0, 0, 0, 0, D5, D6, D7, 0, D9, 0, 0, 0, 0);
                //Copio los valores de la clase de entrada de datos en la aplicación principal
                punteroaplicacion1.equipos11.Add(desaireador18);
