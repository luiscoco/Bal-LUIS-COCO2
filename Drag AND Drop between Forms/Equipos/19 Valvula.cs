...
{
    public partial class Valvula : Form
    {
        ...
        public Valvula(Aplicacion punteroaplicion,Double numecuaciones1,Double numvariables1, Double ediciononuevo, int indice)
        {
            InitializeComponent();           
        ...
        public void funcionauxiliar()
        {
            ...
            ecuaciones1=generaecucaiones(D1,D2,D3,D4,D5,D6,D7,D8,D9,correntrada,corrsalida);
        ...
        private List<String> generaecucaiones(Double D1, Double D2,Double D3,Double D4, Double D5,Double D6,Double D7, Double D8, Double D9, Double correntrada, Double corrsalida)
        {
            //Lista de cadenas que guardan las ecuaciones del sistema
        ...
        public void funcionauxiliar1()
        {
            ...
            if (ediciononuevo1 == 0)
            {
                ...
                Equipos valvula19 = new Equipos();
                valvula19.Inicializar(numequipo, 19, correntrada, 0, corrsalida, 0, D1, D2, D3, D4, D5, D6, D7, D8, D9, 0, 0, 0, 0);
                //Copio los valores de la clase de entrada de datos en la aplicación principal
                punteroaplicacion1.equipos11.Add(valvula19);
