...
{
    public partial class Intercambiador : Form
    {
        ...
        public Intercambiador(Aplicacion punteroaplicion, Double numecuaciones1, Double numvariables1, Double ediciononuevo, int indice)
        {
            InitializeComponent();           
