...
namespace Drag_AND_Drop_between_Forms
{
    public partial class Perdidacarga : Form
    {
        ...
        public Perdidacarga(Aplicacion punteroaplicion,Double numecuaciones1,Double numvariables1, Double ediciononuevo, int indice)
        {
            InitializeComponent();           
        ...
        private List<String> generaecucaiones(Double D1, Double D2,Double D3,Double D4, Double D5, Double D6, Double D7,Double D8, Double correntrada, Double corrsalida)
        {
            ...
            ecuaciones2.Add("");
            ecuaciones2[auxiliar] = "P" + Convert.ToString(correntrada) + "-" + "P" + Convert.ToString(corrsalida) + "-" + ap1 + ap2;
            auxiliar++;
        ...
        public void funcionauxiliar1()
        {
            ...
            if (ediciononuevo1 == 0)
            {
                ...
                Equipos perdcarga3 = new Equipos();
                perdcarga3.Inicializar(numequipo, 3, correntrada, 0, corrsalida, 0, D1, D2, D3, D4, D5, D6, D7, D8, 0, 0, 0, 0, 0);
                //Copio los valores de la clase de entrada de datos en la aplicación principal
                punteroaplicacion1.equipos11.Add(perdcarga3);
