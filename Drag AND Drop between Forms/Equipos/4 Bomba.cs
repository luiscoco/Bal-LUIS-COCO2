...
namespace Drag_AND_Drop_between_Forms
{
    ...
    {
        public Double D1,D2, D3, D4, D5,D7, D8, D9;
        ...
        public Bomba(Aplicacion punteroaplicion,Double numecuaciones1,Double numvariables1, Double ediciononuevo, int indice)
        {
            InitializeComponent();           
        ...
        private List<String> generaecucaiones(Double D1, Double D2,Double D3,Double D4, Double D5,Double D7, Double D8, Double D9, Double correntrada, Double corrsalida)
        {
            ...
            //Calculo de la Entalpía de Descarga en fución de la Potencia de la Bomba
            if((D4>0)&&(D9!=0))
            {     
               ecuaciones2.Add("");
            ...
            {
                //Conversión de Presión de psia a lb/ft2
                //ptemp = D5 * 144;
                //Conversión de Presión de lb/ft2 a ft (de columna de agua), multiplicamos (lb/ft2)*(ft3/lb)
                //TDH = ptemp * punteroaplicacion1.acceso.vph(P1, H1);

                //Factor de conversión de Lbxft a BTU:0.001285
                ecuaciones2.Add("");
                ecuaciones2[auxiliar] = "W" + Convert.ToString(correntrada) + "-" + "(" + "H" + Convert.ToString(corrsalida) + "-" + "H" + Convert.ToString(correntrada) + ")" + "(TDH x W1)/Rend.";
                auxiliar++;
            }
            ...
            else if (D9 == 1)
            {
                ...
                //Si la Tabla de TDH viene dada en ft hay que pasar de ft a psia: ft x lb/ft3 (densidad) = lb/ft2 x 0.006944444= psia
                auxiliar++;
            }
        ...
        public void funcionauxiliar1()
        {
            ...
            if (ediciononuevo1 == 0)
            {
                ...
                Equipos bomba4 = new Equipos();
                bomba4.Inicializar(numequipo, 4, correntrada, 0, corrsalida, 0, D1, D2, D3, D4, D5, 0, D7, D8, D9, 0, 0, 0, 0);
                //Copio los valores de la clase de entrada de datos en la aplicación principal
                punteroaplicacion1.equipos11.Add(bomba4);
