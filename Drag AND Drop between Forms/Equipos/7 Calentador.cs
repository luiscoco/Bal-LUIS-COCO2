...
namespace Drag_AND_Drop_between_Forms
{
    public partial class Calentador : Form
    {
        ...
        public Double correntrada1,correntrada2,correntrada3, corrsalida1,corrsalida2;
        ...
        public Calentador(Aplicacion punteroaplicion,Double numecuaciones1,Double numvariables1, Double ediciononuevo, int indice)
        {
            InitializeComponent();           
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            D9 = Convert.ToDouble(textBox13.Text);
        ...
        public void funcionauxiliar1() 
        {
            ...
            if (ediciononuevo1 == 0)
            {
                ...
                Equipos calentador7 = new Equipos();
                calentador7.Inicializar(numequipo, 7, correntrada1, correntrada2, corrsalida1, corrsalida2, D1, D2, D3, D4, D5, D6, D7, D8, D9, 0, 0, 0, 0);
                //Copio los valores de la clase de entrada de datos en la aplicación principal
                punteroaplicacion1.equipos11.Add(calentador7);
