...
namespace Drag_AND_Drop_between_Forms
{
    public partial class Calentador : Form
    {
        ...
        Double correntrada1,correntrada2,correntrada3, corrsalida1,corrsalida2;
        Double numequipo;
        ...
        public Calentador(Aplicacion punteroaplicion,Double numecuaciones1,Double numvariables1)
        {
            InitializeComponent();           
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            D9 = Convert.ToDouble(textBox10.Text);

            correntrada1=Convert.ToDouble(textBox11.Text);
            correntrada2 = Convert.ToDouble(textBox12.Text);
            correntrada3 = Convert.ToDouble(textBox13.Text);
            corrsalida1 = Convert.ToDouble(textBox14.Text);
            corrsalida2 = Convert.ToDouble(textBox15.Text);
            ...
            //PENDIENTE INCLUIR CONDICIONES INICIALES DE LAS ENTALPÍAS BASÁNDONOS EN LOS VALORES DEL TTD Y DCA INTRODUCIDOS POR EL USUARIO
            ...
            ecuaciones1=generaecucaiones(D1,D2,D3,D4,D5,D6,D7,D8,D9,correntrada1,correntrada2,correntrada3,corrsalida1,corrsalida2);
        ...
        private List<String> generaecucaiones(Double D1, Double D2,Double D3,Double D4, Double D5,Double D6,Double D7,Double D8,Double D9, Double correntrada1, Double correntrada2,Double correntrada3, Double corrsalida1,Double corrsalida2)
        {
            //Lista de cadenas que guardan las ecuaciones del sistema
            ...
            W5 = punteroaplicacion1.p.Find(p => p.Nombre == "W" + Convert.ToString(correntrada3));
            ...
            P5 = punteroaplicacion1.p.Find(p => p.Nombre == "P" + Convert.ToString(correntrada3));
            ...
            H5 = punteroaplicacion1.p.Find(p => p.Nombre == "H" + Convert.ToString(correntrada3));
            ...
            ecuaciones2.Add("");
            ecuaciones2[auxiliar] = "W" + Convert.ToString(correntrada2) + "+" + "W" + Convert.ToString(correntrada3) + "-" + "W" + Convert.ToString(corrsalida2);
            ...
            ecuaciones2.Add("");
            ecuaciones2[auxiliar] = "(" + "W" + Convert.ToString(correntrada1) + "*" + "(" + "H" + Convert.ToString(corrsalida1) + "-" + "H" + Convert.ToString(correntrada1) + ")" + ")" + "-" + "(" + "W" + Convert.ToString(correntrada2) + "*" + Convert.ToString(D6) + "*" + "(" + "H" + Convert.ToString(correntrada2) + "-" + "H" + Convert.ToString(corrsalida2) + ")" + ")" + "-" + "(" + Convert.ToString(D6) + "*" + "W" + Convert.ToString(correntrada3) + "*" + "(" + "H" + Convert.ToString(correntrada3) + "-" + "H" + Convert.ToString(corrsalida2) + ")";
            ...
            {
                ecuaciones2.Add("");
                ecuaciones2[auxiliar] = "T" + Convert.ToString(corrsalida1) + "-" + "Tsat(Pentrada2)" + "+" + Convert.ToString(D5);
                Func<Double> sextaecuacion = () => punteroaplicacion1.acceso.tph(P3, H3) - punteroaplicacion1.acceso.tsl(P2) + D5;
            ...
            {
                ecuaciones2.Add("");
                ecuaciones2[auxiliar] = "T" + Convert.ToString(corrsalida1) + "-" + "Tsat(Pentrada2)" + "+" +"Tabla TTD(W1)";
                Func<Double> sextaecuacion = () => punteroaplicacion1.acceso.tph(P3, H3) - punteroaplicacion1.acceso.tsl(P2) + punteroaplicacion1.tabla(D5,W1,2);
                punteroaplicacion1.functions.Add(sextaecuacion);
                auxiliar++;      
            }

            //Calentador Humedo DCA>0
            if (D4 > 0)
            {
                if (D4 <= 500)
                {
                    ecuaciones2.Add("");
                    ecuaciones2[auxiliar] = "T" + Convert.ToString(corrsalida2) + "-" + "T" + Convert.ToString(correntrada1) + "-" + Convert.ToString(D4);
                    Func<Double> septimaecuacion = () => punteroaplicacion1.acceso.tph(P4, H4) - punteroaplicacion1.acceso.tph(P1, H1) - D4;
                ...
                {
                    ecuaciones2.Add("");
                    ecuaciones2[auxiliar] = "T" + Convert.ToString(corrsalida2) + "-" + "T" + Convert.ToString(correntrada1) + "-" + "Tabla DCA(W1)";
                    Func<Double> septimaecuacion = () => punteroaplicacion1.acceso.tph(P4, H4) - punteroaplicacion1.acceso.tph(P1, H1) - punteroaplicacion1.tabla(D4,W1,2);
                    punteroaplicacion1.functions.Add(septimaecuacion);
                    auxiliar++;
                }
            }

            //Calentador Seco DCA=0
            else if (D4 == 0)
            {
                ecuaciones2.Add("");
                ecuaciones2[auxiliar] = "T" + Convert.ToString(corrsalida2) + "-" + "Tsat(P2)";
                Func<Double> septimaecuacion = () => punteroaplicacion1.acceso.tph(P4, H4) - punteroaplicacion1.acceso.tph(P1, H1);
                punteroaplicacion1.functions.Add(septimaecuacion);
                auxiliar++;
            }
            ...
            {
                ecuaciones2.Add("");
                ecuaciones2[auxiliar] = "P" + Convert.ToString(correntrada3) + "-" + "P" + Convert.ToString(correntrada2);
                Func<Double> octavaecuacion = () => P5 - P2;
                punteroaplicacion1.functions.Add(octavaecuacion);
                auxiliar++;            
            }
