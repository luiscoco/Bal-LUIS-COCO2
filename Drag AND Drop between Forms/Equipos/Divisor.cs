...
namespace Drag_AND_Drop_between_Forms
{
    public partial class Divisor : Form
    {
        ...
        public Divisor(Aplicacion punteroaplicion,Double numecuaciones1,Double numvariables1)
        {
            InitializeComponent();           
        ...
        private List<String> generaecucaiones(Double D1, Double D2,Double D3, Double correntrada, Double corrsalida1,Double corrsalida2)
        {
            ...
            punteroaplicacion1.p[(int)numparametroscreados].Value = 0.9*punteroaplicacion1.p.Find(p => p.Nombre == "W" + Convert.ToString(correntrada)).Value;
            punteroaplicacion1.p[(int)numparametroscreados + 1].Nombre = "W" + Convert.ToString(corrsalida2);
            punteroaplicacion1.p[(int)numparametroscreados + 1].Value = 0.1 * punteroaplicacion1.p.Find(p => p.Nombre == "W" + Convert.ToString(correntrada)).Value;
