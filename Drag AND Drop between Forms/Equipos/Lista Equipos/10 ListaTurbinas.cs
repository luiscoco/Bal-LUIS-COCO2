...
{
    public partial class ListaTurbinas10 : Form
    {
        Aplicacion puntero1;

        public ListaTurbinas10(Aplicacion puntero)
        {
            puntero1 = puntero;
        ...
        private void ListaTurbinas10_Load(object sender, EventArgs e)
        {
            LeerEquipos();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (turbina10.ShowDialog(this) == System.Windows.Forms.DialogResult.OK)
            {
               listBox1.Items.Add("Equipo Nº: "+Convert.ToString(puntero1.equipos11[puntero1.numequipos-1].numequipo2)+"   Tipo Equipo: " +Convert.ToString(10));
            }            
        }
        ...
        private void LeerEquipos()
        {
            for (int i = 0; i <puntero1.equipos11.Count; i++)
            {
                ...
                if (puntero1.equipos11[i].tipoequipo2 == 10)
                {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Turbina10 turb10=new Turbina10(puntero1, puntero1.numecuaciones, puntero1.numvariables,1,indice);
            ...
            {
                turb10.textBox1.Text = Convert.ToString(puntero1.equipos11[indice].aD1);
                //Presión  psia a Bar
                turb10.textBox10.Text = Convert.ToString(puntero1.equipos11[indice].aD2 * (6.8947572 / 100));           
                turb10.textBox2.Text = Convert.ToString(puntero1.equipos11[indice].aD3);
                turb10.textBox3.Text = Convert.ToString(puntero1.equipos11[indice].aD4);
                turb10.textBox4.Text = Convert.ToString(puntero1.equipos11[indice].aD5);
                turb10.textBox5.Text = Convert.ToString(puntero1.equipos11[indice].aD8);               
            }
            ...
            else if (puntero1.unidades == 0)
            {
                turb10.textBox1.Text = Convert.ToString(puntero1.equipos11[indice].aD1);
                //Presión psia
                turb10.textBox10.Text = Convert.ToString(puntero1.equipos11[indice].aD2);
                turb10.textBox2.Text = Convert.ToString(puntero1.equipos11[indice].aD3);
                turb10.textBox3.Text = Convert.ToString(puntero1.equipos11[indice].aD4);
                turb10.textBox4.Text = Convert.ToString(puntero1.equipos11[indice].aD5);
                turb10.textBox5.Text = Convert.ToString(puntero1.equipos11[indice].aD8);
            ...
            turb10.textBox7.Text=Convert.ToString(puntero1.equipos11[indice].aN1);
            turb10.textBox8.Text = Convert.ToString(puntero1.equipos11[indice].aN3);
            turb10.textBox9.Text = Convert.ToString(puntero1.equipos11[indice].numequipo2);
