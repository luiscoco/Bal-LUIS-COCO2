...
{
    public partial class ListaMSR : Form
    {
        Aplicacion puntero1;

        public ListaMSR(Aplicacion puntero)
        {
            puntero1 = puntero;
        ...
        private void ListaMSR_Load(object sender, EventArgs e)
        {
            LeerEquipos();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            MSR msr14 = new MSR(puntero1, puntero1.numecuaciones, puntero1.numvariables,0,0);
            if (msr14.ShowDialog(this) == System.Windows.Forms.DialogResult.OK)
            {
               listBox1.Items.Add("Equipo Nº: "+Convert.ToString(puntero1.equipos11[puntero1.numequipos-1].numequipo2)+"   Tipo Equipo: " +Convert.ToString(14));
            }            
        }
        ...
        private void LeerEquipos()
        {
            for (int i = 0; i <puntero1.equipos11.Count; i++)
            {
                ...
                if (puntero1.equipos11[i].tipoequipo2 == 14)
                {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            MSR msr14=new MSR(puntero1, puntero1.numecuaciones, puntero1.numvariables,1,indice);
            ...
            if (puntero1.unidades == 1)
            {
                ...
                msr14.textBox1.Text = Convert.ToString(puntero1.equipos11[indice].aD1 * (6.8947572 / 100));
                //Factor lineal de pérdida de carga
                msr14.textBox2.Text = Convert.ToString(puntero1.equipos11[indice].aD2 /6.578911309);
                //Factor cuadrático de pérdida de carga
                msr14.textBox3.Text = Convert.ToString(puntero1.equipos11[indice].aD3 / 2.984193609);
                msr14.textBox4.Text = Convert.ToString(puntero1.equipos11[indice].aD4);
                //Convertir el TTD de ºF a ºC
                msr14.textBox5.Text = Convert.ToString(puntero1.equipos11[indice].aD5*(5.0/9.0));
                msr14.textBox6.Text = Convert.ToString(puntero1.equipos11[indice].aD6);
                //Presión de psia a Bar
                msr14.textBox7.Text = Convert.ToString(puntero1.equipos11[indice].aD7 * (6.8947572 / 100));
                //Factor lineal de pérdida de carga
                msr14.textBox8.Text = Convert.ToString(puntero1.equipos11[indice].aD8 /6.578911309);
                //Factor cuadrático de pérdida de carga
                msr14.textBox14.Text = Convert.ToString(puntero1.equipos11[indice].aD9 /2.984193609);
            }
            ...
            {
                msr14.textBox1.Text = Convert.ToString(puntero1.equipos11[indice].aD1);
                msr14.textBox2.Text = Convert.ToString(puntero1.equipos11[indice].aD2);
                msr14.textBox3.Text = Convert.ToString(puntero1.equipos11[indice].aD3);
                msr14.textBox4.Text = Convert.ToString(puntero1.equipos11[indice].aD4);
                msr14.textBox5.Text = Convert.ToString(puntero1.equipos11[indice].aD5);
                msr14.textBox6.Text = Convert.ToString(puntero1.equipos11[indice].aD6);
                msr14.textBox7.Text = Convert.ToString(puntero1.equipos11[indice].aD7);
                msr14.textBox8.Text = Convert.ToString(puntero1.equipos11[indice].aD8);
                msr14.textBox14.Text = Convert.ToString(puntero1.equipos11[indice].aD9);
            }

            msr14.textBox10.Text = Convert.ToString(puntero1.equipos11[indice].aN1);
            msr14.textBox11.Text = Convert.ToString(puntero1.equipos11[indice].aN2);
            msr14.textBox12.Text = Convert.ToString(puntero1.equipos11[indice].aN3);
            msr14.textBox13.Text = Convert.ToString(puntero1.equipos11[indice].aN4);
            msr14.textBox9.Text = Convert.ToString(puntero1.equipos11[indice].numequipo2);
