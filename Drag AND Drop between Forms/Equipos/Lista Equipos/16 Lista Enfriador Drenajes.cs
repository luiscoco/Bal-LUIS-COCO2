...
{
    public partial class ListaDrainageCooling16 : Form
    {
        Aplicacion puntero1;

        public ListaDrainageCooling16(Aplicacion puntero)
        {
            puntero1 = puntero;
        ...
        private void ListaDrainageCooling16_Load(object sender, EventArgs e)
        {
            LeerEquipos();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            EnfriadorDrenajes enfriador16 = new EnfriadorDrenajes(puntero1, puntero1.numecuaciones, puntero1.numvariables,0,0);
            if (enfriador16.ShowDialog(this) == System.Windows.Forms.DialogResult.OK)
            {
               listBox1.Items.Add("Equipo Nº: "+Convert.ToString(puntero1.equipos11[puntero1.numequipos-1].numequipo2)+"   Tipo Equipo: " +Convert.ToString(16));
            }            
        }
        ...
        private void LeerEquipos()
        {
            for (int i = 0; i <puntero1.equipos11.Count; i++)
            {
                ...
                if (puntero1.equipos11[i].tipoequipo2 == 16)
                {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            EnfriadorDrenajes enfriador16=new EnfriadorDrenajes(puntero1, puntero1.numecuaciones, puntero1.numvariables,1,indice);
            ...
            {
                enfriador16.textBox1.Text = Convert.ToString(puntero1.equipos11[indice].aD1 * (6.8947572 / 100));
                enfriador16.textBox2.Text = Convert.ToString(puntero1.equipos11[indice].aD2 / 6.578911309);
                enfriador16.textBox3.Text = Convert.ToString(puntero1.equipos11[indice].aD3 / 2.984193609);
                if (puntero1.equipos11[indice].aD4 > 500)
                {
                    enfriador16.textBox4.Text = Convert.ToString(puntero1.equipos11[indice].aD4);
                }
                else if (puntero1.equipos11[indice].aD4 < 500)
                {
                    enfriador16.textBox4.Text = Convert.ToString(puntero1.equipos11[indice].aD4 * (5.0 / 9.0));
                }
               
                enfriador16.textBox5.Text = Convert.ToString(puntero1.equipos11[indice].aD6);
                enfriador16.textBox12.Text = Convert.ToString(puntero1.equipos11[indice].aD8);         
            }
            ...
            {
                enfriador16.textBox1.Text = Convert.ToString(puntero1.equipos11[indice].aD1);
                enfriador16.textBox2.Text = Convert.ToString(puntero1.equipos11[indice].aD2);
                enfriador16.textBox3.Text = Convert.ToString(puntero1.equipos11[indice].aD3);
                enfriador16.textBox4.Text = Convert.ToString(puntero1.equipos11[indice].aD4);              
                enfriador16.textBox5.Text = Convert.ToString(puntero1.equipos11[indice].aD6);
                enfriador16.textBox12.Text = Convert.ToString(puntero1.equipos11[indice].aD8);    
            }

            enfriador16.textBox7.Text = Convert.ToString(puntero1.equipos11[indice].aN1);
            enfriador16.textBox8.Text = Convert.ToString(puntero1.equipos11[indice].aN2);
            enfriador16.textBox10.Text = Convert.ToString(puntero1.equipos11[indice].aN3);
            enfriador16.textBox11.Text = Convert.ToString(puntero1.equipos11[indice].aN4);
            enfriador16.textBox9.Text = Convert.ToString(puntero1.equipos11[indice].numequipo2);

            enfriador16.ShowDialog();
