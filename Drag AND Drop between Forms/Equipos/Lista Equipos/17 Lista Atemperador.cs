...
{
    public partial class ListaAtemperador17 : Form
    {
        Aplicacion puntero1;

        public ListaAtemperador17(Aplicacion puntero)
        {
            puntero1 = puntero;
        ...
        private void ListaAtemperador17_Load(object sender, EventArgs e)
        {
            LeerEquipos();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            Atemperador atemperador17 = new Atemperador(puntero1, puntero1.numecuaciones, puntero1.numvariables,0,0);
            if (atemperador17.ShowDialog(this) == System.Windows.Forms.DialogResult.OK)
            {
               listBox1.Items.Add("Equipo Nº: "+Convert.ToString(puntero1.equipos11[puntero1.numequipos-1].numequipo2)+"   Tipo Equipo: " +Convert.ToString(17));
            }            
        }
        ...
        private void LeerEquipos()
        {
            for (int i = 0; i <puntero1.equipos11.Count; i++)
            {
                ...
                if (puntero1.equipos11[i].tipoequipo2 == 17)
                {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Atemperador atemperador=new Atemperador(puntero1, puntero1.numecuaciones, puntero1.numvariables,1,indice);
            ...
            {
                atemperador.textBox1.Text = Convert.ToString(puntero1.equipos11[indice].aD1 * (6.8947572 / 100));
                atemperador.textBox2.Text = Convert.ToString(puntero1.equipos11[indice].aD2 / 6.578911309);
                atemperador.textBox3.Text = Convert.ToString(puntero1.equipos11[indice].aD3 / 2.984193609);
                atemperador.textBox4.Text = Convert.ToString(puntero1.equipos11[indice].aD4);
                atemperador.textBox5.Text = Convert.ToString(puntero1.equipos11[indice].aD5 * (5.0/9.0));
                atemperador.textBox6.Text = Convert.ToString(puntero1.equipos11[indice].aD6);
            }
            ...
            {
                atemperador.textBox1.Text = Convert.ToString(puntero1.equipos11[indice].aD1);
                atemperador.textBox2.Text = Convert.ToString(puntero1.equipos11[indice].aD2);
                atemperador.textBox3.Text = Convert.ToString(puntero1.equipos11[indice].aD3);
                atemperador.textBox4.Text = Convert.ToString(puntero1.equipos11[indice].aD4);
                atemperador.textBox5.Text = Convert.ToString(puntero1.equipos11[indice].aD5);
                atemperador.textBox6.Text = Convert.ToString(puntero1.equipos11[indice].aD6);
            }

            atemperador.textBox7.Text = Convert.ToString(puntero1.equipos11[indice].aN1);
            atemperador.textBox8.Text = Convert.ToString(puntero1.equipos11[indice].aN2);
            atemperador.textBox10.Text = Convert.ToString(puntero1.equipos11[indice].aN3);
            atemperador.textBox9.Text = Convert.ToString(puntero1.equipos11[indice].numequipo2);

            atemperador.ShowDialog();
