...
{
    public partial class ListaValvula19 : Form
    {
        Aplicacion puntero1;

        public ListaValvula19(Aplicacion puntero)
        {
            puntero1 = puntero;
        ...
        private void ListaValvula19_Load(object sender, EventArgs e)
        {
            LeerEquipos();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            Valvula valvula19 = new Valvula(puntero1, puntero1.numecuaciones, puntero1.numvariables,0,0);
            if (valvula19.ShowDialog(this) == System.Windows.Forms.DialogResult.OK)
            {
               listBox1.Items.Add("Equipo Nº: "+Convert.ToString(puntero1.equipos11[puntero1.numequipos-1].numequipo2)+"   Tipo Equipo: " +Convert.ToString(19));
            }            
        }
        ...
        private void LeerEquipos()
        {
            for (int i = 0; i <puntero1.equipos11.Count; i++)
            {
                ...
                if (puntero1.equipos11[i].tipoequipo2 == 19)
                {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Valvula valvula19=new Valvula(puntero1, puntero1.numecuaciones, puntero1.numvariables,1,indice);
            ...
            {
                valvula19.textBox1.Text = Convert.ToString(puntero1.equipos11[indice].aD1 * (6.8947572 / 100));
                valvula19.textBox3.Text = Convert.ToString(puntero1.equipos11[indice].aD2 / 6.578911309);
                valvula19.textBox4.Text = Convert.ToString(puntero1.equipos11[indice].aD3 / 2.984193609);
                valvula19.textBox6.Text = Convert.ToString(puntero1.equipos11[indice].aD4);
                valvula19.textBox3.Text = Convert.ToString(puntero1.equipos11[indice].aD5);
                valvula19.textBox4.Text = Convert.ToString(puntero1.equipos11[indice].aD6 * 1.727482106);
                valvula19.textBox6.Text = Convert.ToString(puntero1.equipos11[indice].aD7);
                valvula19.textBox5.Text = Convert.ToString(puntero1.equipos11[indice].aD8);
                valvula19.textBox5.Text = Convert.ToString(puntero1.equipos11[indice].aD8); 
            }
            ...
            {
                valvula19.textBox1.Text = Convert.ToString(puntero1.equipos11[indice].aD1);
                valvula19.textBox3.Text = Convert.ToString(puntero1.equipos11[indice].aD2);
                valvula19.textBox4.Text = Convert.ToString(puntero1.equipos11[indice].aD3);
                valvula19.textBox6.Text = Convert.ToString(puntero1.equipos11[indice].aD4);
                valvula19.textBox3.Text = Convert.ToString(puntero1.equipos11[indice].aD5);
                valvula19.textBox4.Text = Convert.ToString(puntero1.equipos11[indice].aD6);
                valvula19.textBox6.Text = Convert.ToString(puntero1.equipos11[indice].aD7);
                valvula19.textBox5.Text = Convert.ToString(puntero1.equipos11[indice].aD8);
                valvula19.textBox5.Text = Convert.ToString(puntero1.equipos11[indice].aD8); 
            }

            valvula19.textBox7.Text = Convert.ToString(puntero1.equipos11[indice].aN1);
            valvula19.textBox8.Text = Convert.ToString(puntero1.equipos11[indice].aN3);
            valvula19.textBox9.Text = Convert.ToString(puntero1.equipos11[indice].numequipo2);

            valvula19.ShowDialog();
