...
{
    public partial class ListaDivisorEntalpiaFija : Form
    {
        Aplicacion puntero1;

        public ListaDivisorEntalpiaFija(Aplicacion puntero)
        {
            puntero1 = puntero;
        ...
        private void ListaDivisorEntalpiaFija_Load(object sender, EventArgs e)
        {
            LeerEquipos();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            Divisorentalpiafija diventalpiafija20 = new Divisorentalpiafija(puntero1, puntero1.numecuaciones, puntero1.numvariables,0,0);
            if (diventalpiafija20.ShowDialog(this) == System.Windows.Forms.DialogResult.OK)
            {
               listBox1.Items.Add("Equipo Nº: "+Convert.ToString(puntero1.equipos11[puntero1.numequipos-1].numequipo2)+"   Tipo Equipo: " +Convert.ToString(20));
            }            
        }
        ...
        private void LeerEquipos()
        {
            for (int i = 0; i <puntero1.equipos11.Count; i++)
            {
                ...
                if (puntero1.equipos11[i].tipoequipo2 == 20)
                {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Divisorentalpiafija diventalpiafija=new Divisorentalpiafija(puntero1, puntero1.numecuaciones, puntero1.numvariables,1,indice);
            ...
            if (puntero1.unidades == 1)
            {
                ...
                diventalpiafija.textBox1.Text = Convert.ToString(puntero1.equipos11[indice].aD1 * (0.4536));
                //Conversión de Entalpía del Sistema Métrico a Británicas (Kj/Kgr a Btu/Lb)
                diventalpiafija.textBox2.Text = Convert.ToString(puntero1.equipos11[indice].aD2 * 2.326009);
                //Conversión de Presión del Sistema Métrico a Británicas (Bar a psia)
                diventalpiafija.textBox3.Text = Convert.ToString(puntero1.equipos11[indice].aD3 * (6.8947572 / 100)); 
            }
            ...
            {
                diventalpiafija.textBox1.Text = Convert.ToString(puntero1.equipos11[indice].aD1);
                diventalpiafija.textBox2.Text = Convert.ToString(puntero1.equipos11[indice].aD2);
                diventalpiafija.textBox3.Text = Convert.ToString(puntero1.equipos11[indice].aD3);   
            }

            diventalpiafija.textBox7.Text = Convert.ToString(puntero1.equipos11[indice].aN1);
            diventalpiafija.textBox8.Text = Convert.ToString(puntero1.equipos11[indice].aN3);
            diventalpiafija.textBox4.Text = Convert.ToString(puntero1.equipos11[indice].aN4);
            diventalpiafija.textBox9.Text = Convert.ToString(puntero1.equipos11[indice].numequipo2);

            diventalpiafija.ShowDialog();
