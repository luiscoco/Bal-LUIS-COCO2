...
{
    public partial class ListaFlashTank21 : Form
    {
        Aplicacion puntero1;

        public ListaFlashTank21(Aplicacion puntero)
        {
            puntero1 = puntero;
        ...
        private void ListaFlashTank21_Load(object sender, EventArgs e)
        {
            LeerEquipos();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
           ...
           TanqueVaporizacion tanque21 = new TanqueVaporizacion(puntero1, puntero1.numecuaciones, puntero1.numvariables,0,0);
            if (tanque21.ShowDialog(this) == System.Windows.Forms.DialogResult.OK)
            {
               listBox1.Items.Add("Equipo Nº: "+Convert.ToString(puntero1.equipos11[puntero1.numequipos-1].numequipo2)+"   Tipo Equipo: " +Convert.ToString(21));
            }            
        }
        ...
        private void LeerEquipos()
        {
            for (int i = 0; i <puntero1.equipos11.Count; i++)
            {
                ...
                if (puntero1.equipos11[i].tipoequipo2 == 21)
                {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            TanqueVaporizacion tanque21=new TanqueVaporizacion(puntero1, puntero1.numecuaciones, puntero1.numvariables,1,indice);
            ...
            {
                //Presión Bar a psia
                tanque21.textBox1.Text = Convert.ToString(puntero1.equipos11[indice].aD1 * (6.8947572 / 100));               
            }
            ...
            {
                //Presión Bar a psia
                tanque21.textBox1.Text = Convert.ToString(puntero1.equipos11[indice].aD1);   
            }

            tanque21.textBox7.Text = Convert.ToString(puntero1.equipos11[indice].aN1);
            tanque21.textBox8.Text = Convert.ToString(puntero1.equipos11[indice].aN3);
            tanque21.textBox4.Text = Convert.ToString(puntero1.equipos11[indice].numequipo2);
