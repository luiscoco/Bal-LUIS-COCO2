...
{
    public partial class ListaPerdidaCarga : Form
    {
        Aplicacion puntero1;

        public ListaPerdidaCarga(Aplicacion puntero)
        {
            puntero1 = puntero;
        ...
        private void ListaPerdidaCarga_Load(object sender, EventArgs e)
        {
            LeerEquipos();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            Perdidacarga perdcarga3 = new Perdidacarga(puntero1, puntero1.numecuaciones, puntero1.numvariables,0,0);
            if (perdcarga3.ShowDialog(this) == System.Windows.Forms.DialogResult.OK)
            {
               listBox1.Items.Add("Equipo Nº: "+Convert.ToString(puntero1.equipos11[puntero1.numequipos-1].numequipo2)+"   Tipo Equipo: " +Convert.ToString(3));
            }            
        }
        ...
        private void LeerEquipos()
        {
            for (int i = 0; i <puntero1.equipos11.Count; i++)
            {
                ...
                if (puntero1.equipos11[i].tipoequipo2 == 3)
                {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Perdidacarga perdcarga3=new Perdidacarga(puntero1, puntero1.numecuaciones, puntero1.numvariables,1,indice);
            ...
            {
                perdcarga3.textBox1.Text = Convert.ToString(puntero1.equipos11[indice].aD1 * (6.8947572 / 100));
                perdcarga3.textBox2.Text = Convert.ToString(puntero1.equipos11[indice].aD2 / 6.578911309);
                perdcarga3.textBox3.Text = Convert.ToString(puntero1.equipos11[indice].aD3 / 2.984193609);
                perdcarga3.textBox4.Text = Convert.ToString(puntero1.equipos11[indice].aD4);
                perdcarga3.textBox5.Text = Convert.ToString(puntero1.equipos11[indice].aD5);
                perdcarga3.textBox6.Text = Convert.ToString(puntero1.equipos11[indice].aD6*(1000/ 3.28083));
                perdcarga3.textBox7.Text = Convert.ToString(puntero1.equipos11[indice].aD7 / 3.28083);
                perdcarga3.textBox8.Text = Convert.ToString(puntero1.equipos11[indice].aD8);
            }
            ...
            perdcarga3.textBox10.Text = Convert.ToString(puntero1.equipos11[indice].aN1);
            perdcarga3.textBox11.Text = Convert.ToString(puntero1.equipos11[indice].aN3);
            perdcarga3.textBox9.Text = Convert.ToString(puntero1.equipos11[indice].numequipo2);

            perdcarga3.ShowDialog();
