...
{
    public partial class ListaMezclador : Form
    {
        Aplicacion puntero1;

        public ListaMezclador(Aplicacion puntero)
        {
            puntero1 = puntero;
        ...
        private void ListaMezclador_Load(object sender, EventArgs e)
        {
            LeerEquipos();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            Mezclador mezclador5 = new Mezclador(puntero1, puntero1.numecuaciones, puntero1.numvariables,0,0);
            if (mezclador5.ShowDialog(this) == System.Windows.Forms.DialogResult.OK)
            {
               listBox1.Items.Add("Equipo Nº: "+Convert.ToString(puntero1.equipos11[puntero1.numequipos-1].numequipo2)+"   Tipo Equipo: " +Convert.ToString(5));
            }            
        }
        ...
        private void LeerEquipos()
        {
            for (int i = 0; i <puntero1.equipos11.Count; i++)
            {
                ...
                if (puntero1.equipos11[i].tipoequipo2 == 5)
                {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Mezclador mezclad5=new Mezclador(puntero1, puntero1.numecuaciones, puntero1.numvariables,1,indice);
            ...
            if (puntero1.unidades == 1)
            {
                ...
                mezclad5.textBox1.Text = Convert.ToString(puntero1.equipos11[indice].aD1 * (6.8947572 / 100));
                mezclad5.textBox2.Text = Convert.ToString(puntero1.equipos11[indice].aD9);                    
            }
            ...
            {
                //Presión de Operación en Carcasa de psi a Bar
                mezclad5.textBox1.Text = Convert.ToString(puntero1.equipos11[indice].aD1);
                mezclad5.textBox2.Text = Convert.ToString(puntero1.equipos11[indice].aD9);    
            }

            mezclad5.textBox3.Text = Convert.ToString(puntero1.equipos11[indice].aN1);
            mezclad5.textBox4.Text = Convert.ToString(puntero1.equipos11[indice].aN2);
            mezclad5.textBox5.Text = Convert.ToString(puntero1.equipos11[indice].aN3);
            mezclad5.textBox9.Text = Convert.ToString(puntero1.equipos11[indice].numequipo2);
