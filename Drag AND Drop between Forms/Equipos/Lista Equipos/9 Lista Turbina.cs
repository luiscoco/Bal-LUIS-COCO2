...
{
    public partial class ListaTurbina9 : Form
    {
        Aplicacion puntero1;

        public ListaTurbina9(Aplicacion puntero)
        {
            puntero1 = puntero;
        ...
        private void ListaTurbina9_Load(object sender, EventArgs e)
        {
            LeerEquipos();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            Turbina turbina9 = new Turbina(puntero1, puntero1.numecuaciones, puntero1.numvariables,0,0);
            if (turbina9.ShowDialog(this) == System.Windows.Forms.DialogResult.OK)
            {
               listBox1.Items.Add("Equipo Nº: "+Convert.ToString(puntero1.equipos11[puntero1.numequipos-1].numequipo2)+"   Tipo Equipo: " +Convert.ToString(9));
            }            
        }
        ...
        private void LeerEquipos()
        {
            for (int i = 0; i <puntero1.equipos11.Count; i++)
            {
                ...
                if (puntero1.equipos11[i].tipoequipo2 == 9)
                {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Turbina turbina9=new Turbina(puntero1, puntero1.numecuaciones, puntero1.numvariables,1,indice);
            ...
            if (puntero1.unidades == 1)
            {
                ...
                turbina9.textBox2.Text = Convert.ToString(puntero1.equipos11[indice].aD3 / 2.316749697);
                turbina9.textBox1.Text = Convert.ToString(puntero1.equipos11[indice].aD1);
                turbina9.textBox3.Text = Convert.ToString(puntero1.equipos11[indice].aD4);
                turbina9.textBox4.Text = Convert.ToString(puntero1.equipos11[indice].aD5);
                turbina9.textBox6.Text = Convert.ToString(puntero1.equipos11[indice].aD9);
                turbina9.textBox5.Text = Convert.ToString(puntero1.equipos11[indice].aD8);           
            }
            ...
            {
                //Conversión del Factor de Flujo de Unidades Sistema Internacional a Británicas
                turbina9.textBox2.Text = Convert.ToString(puntero1.equipos11[indice].aD3);
                turbina9.textBox1.Text = Convert.ToString(puntero1.equipos11[indice].aD1);
                turbina9.textBox3.Text = Convert.ToString(puntero1.equipos11[indice].aD4);
                turbina9.textBox4.Text = Convert.ToString(puntero1.equipos11[indice].aD5);
                turbina9.textBox6.Text = Convert.ToString(puntero1.equipos11[indice].aD9);
            ...
            turbina9.textBox7.Text = Convert.ToString(puntero1.equipos11[indice].aN1);
            turbina9.textBox8.Text = Convert.ToString(puntero1.equipos11[indice].aN3);
            turbina9.textBox9.Text = Convert.ToString(puntero1.equipos11[indice].numequipo2);
