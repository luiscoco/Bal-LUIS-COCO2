...
namespace ClaseEquipos
{
    public class ClassBomba4
    {
        ...
        {     
            ...
            potencia = (entalpiacorrsalida-entalpiacorrentrada) * caudalcorrentrada;

            //Cálculo de la EFICIENCIA
            eficiencia = ((entalpiacorrentrada / 2.326009) - acceso.hps(presioncorrsalida / (6.8947572 / 100), (acceso.sph(presioncorrentrada / (6.8947572 / 100), entalpiacorrentrada / 2.326009)))) / ((entalpiacorrentrada / 2.326009) - (entalpiacorrsalida / 2.326009));

            AP = presioncorrsalida - presioncorrentrada;

            Double densidad = 1 / ((volumenespecificoentrada + volumenespecificosalida) / 2);
            TDH= (AP*100000)/(densidad*9.80665);
        }        
    }
}
