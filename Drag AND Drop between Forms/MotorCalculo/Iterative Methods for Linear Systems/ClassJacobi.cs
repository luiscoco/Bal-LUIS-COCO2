...
namespace IterativeMethodsforLinearSystems
{
    ...
    {        
        ...
        public Matrix Jacobi(Matrix x0,Matrix a1,int numberOfFunctions1, int numberOfParameter1,Matrix b1,int numberOfFunctions2,int columnasb2,int numiteraciones)
        {
            ...
            {
                //Calculate first iterative solution
                x = T * x + C;
            }
